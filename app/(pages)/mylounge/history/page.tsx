    ...
    return (
        <>
            ...
            <div className="shopping_his_wrap01 px-5 py-10">
                ...
                <p className="sp_txt8 mb-2 text-[14px] font-normal leading-[1.71] -tracking-[.25px] text-left text-[#767676]"> 2023-01-01 ~ 2023-08-23 </p>
            </div>
            <div className="shopping_his_wrap02 px-5 pb-[50px]">
                <div className="point_lists ">
                    ...
                    <div className="point_use_view flex w-full h-[200px] rounded-2xl overflow-hidden relative bg-gradient-primary mb-0 mx-auto
                    ...
                    <div className="point_use_cont relative grow-[1] shrink-[1] basis-0 h-full box-border p-4">
                        ...
                        <p className="p_year text-[13px] absolute left-4 bottom-[18px] break-keep text-black"> 2023년 </p>
                    </div>
                    <div className="point_bar_wrap grow-[1] shrink-[1] basis-0 flex relative z-[1] items-center">
                        <ul className="bar_accumulate mr-[55px] h-full list-none">
                            <li className="h-full box-border pt-[45px] pb-4 flex flex-col items-end">
                                <div className="bar_graph h-full w-6 rounded-[30px] bg-[#ea035c] mt-auto relative
                        ...
                        <PointBar  type={'use'} point={30} color={"purple"} height={28.0374}></PointBar>
                    </div>
                    </div>
            ...
            <div className="brand_use_wrap01 px-5 pb-5">
                <SpecialTitle color={'pink'} name={'권선'} ptag={'text-[20px] leading-[30px] font-normal break-keep -tracking-[.5px]'}>
                    고객님이 <br/>자주 방문하는 브랜드
                </SpecialTitle>
            </div>
            ...
            <div className="btn_box space1 px-5 pb-10">
                <RoundedButton backgroundColor={"primary"}>고객님을 위한 추천 서비스를 만나보세요!</RoundedButton>
            </div>
            <NoticeBox className={'px-5 bg-[#fbfbfb]'} title={'유의사항'} type={"info"}>
                <ListForNoticeBox className={"text-[12px] leading-[20px] -tracking-[.5px]"} level={2} isBullet={true}>매년 1월 1일 ~ 전일까지의 신세계포인트 적립/사용한 결제 건을 기준으로 집계되며 환불, 취소 등으로 인한 실제 결제 금액과 일부 차이가 있을 수 있습니다.</ListForNoticeBox>
                <ListForNoticeBox className={"text-[12px] leading-[20px] -tracking-[.5px]"} level={2} isBullet={true}>결제 데이터는 결제한 다음 날 반영됩니다. </ListForNoticeBox>
                <ListForNoticeBox className={"text-[12px] leading-[20px] -tracking-[.5px]"} level={2} isBullet={true}>'자주 방문하는 브랜드'는 구매 횟수가 많은 기준입니다.'</ListForNoticeBox>
                <ListForNoticeBox className={"text-[12px] leading-[20px] -tracking-[.5px]"} level={2} isBullet={true}>'많이 쇼핑하는 브랜드'는 구매 금액이 많은 기준입니다.'</ListForNoticeBox>
            </NoticeBox>
        </>
    );
};
