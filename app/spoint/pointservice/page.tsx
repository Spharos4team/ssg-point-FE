...
export default function PointService() {
  ...
  const emarttable = [
    ...
    {
      id: 'emart',
      content: '[이마트] 삼성카드/e카드/SC카드/KB국민카드',
      point: 1,
      colSpan: 2,
      rowSpan: 0,
    },
    {
      id: 'emart',
      content: '[신세계] 씨티카드/SC체크카드/하나카드/신한카드/BC바로카드',
      point: 1,
      colSpan: 2,
      rowSpan: 0,
    },
  ...
  const shinsegaetable = [
    {
      id: 'shinsegae',
      content: '현금, 상품권, 일반 신용카드, 현금 IC카드',
      point: 1,
      colSpan: 2,
      rowSpan: 4,
    },
    {
      id: 'shinsegae',
      content: '[이마트] 삼성카드/e카드/SC카드/신한카드',
      point: 1,
      colSpan: 2,
      rowSpan: 0,
    },
  ...
  const SSGtable = [
    ...
    {
      id: 'SSG',
      content: '[신세계] SC체크카드/하나카드/신한카드/BC바로카드',
      point: 1,
      colSpan: 2,
      rowSpan: 0,
    },
  ...
  const etctable = [
    {
      id: 'etc',
      content: ['스타벅스', '프리미엄 아울렛'],
      url: ['/images/logo_starbucks.png', '/images/logo_premiumoutlets.png'],
      width: [130, 131],
      height: [91, 90],
      point: 1,
      colSpan: 1,
    ...
    {
      id: 'etc',
      content: ['신세계면세점<br/> (신세계온라인면세점)', '신세계팩토리스토어'],
      url: ['/images/logo_ssgdfs.png', '/images/logo_factorystore.png'],
      width: [130, 130],
      height: [90, 90],
      point: 1,
      colSpan: 1,
    ...
    {
      id: 'etc',
      content: ['스타필드', '신세계TV쇼핑'],
      url: ['/images/logo_starfield.png', '/images/logo_tvshopping.png'],
      width: [132, 130],
      height: [90, 90],
      point: 1,
      colSpan: 1,
    ...
    {
      id: 'etc',
      content: ['조선호텔', '신세계 영랑호리조트'],
      url: ['/images/logo_josunhotel.png', '/images/logo_ssgresort.png'],
      width: [130, 131],
      height: [90, 90],
      point: 1,
      colSpan: 1,
    ...
    {
      id: 'etc',
      content: ['신세계푸드', 'CASAMIA'],
      url: ['/images/logo_ssgfood.png', '/images/logo_casamia.png'],
      width: [130, 130],
      height: [90, 90],
      point: 1,
      colSpan: 1,
    ...
    },
    {
      id: 'etc',
      content: ['스무디킹', '시코르'],
      url: ['/images/logo_smoothieking.png', '/images/logo_chicor.png'],
      width: [130, 130],
      height: [90, 90],
      point: 1,
      colSpan: 1,
    ...
    },
    {
      id: 'etc',
      content: ['G마켓', '옥션'],
      url: ['/images/logo_gmarket.png', '/images/logo_auction.png'],
      width: [130, 130],
      height: [82, 82],
      point: 1,
      colSpan: 1,
  ...
  return (
    <>
      <div className="px-5 pb-4 flex justify-between">
        ...
        <button
          className="relative pr-2.5 text-xs text-[#767676] leading-[18px] font-medium
      ...
      <div className="bg-[#fbfbfb] px-5 pt-6 pb-10 relative">
        ...
        <p className="-tracking-[.4px] text-[13px] leadint-[21px] text-[#767676] -mx-2.5 mb-4">
          결제수단별 결제금액에 따라 1천원당 기본 포인트가 적립되며, 결제 제휴 브랜드 또는
          결제수단에 따라 적립 포인트가 달라 집니다.
        </p>
      </div>
      <RadioProvider defaultValue={'emart'}>
        <div className="flex">
          <Tab className="h-[60px]" type="context" id="emart" color="brown">
            <span className="bg-[url('/images/logo_emart.png')] bg-center block w-full h-full bg-[length:62px_58px] bg-no-repeat text-0"></span>
          </Tab>
          <Tab className="h-[60px]" type="context" id="shinsegae" color="brown">
            <span className="bg-[url('/images/logo_shinsegae.png')] bg-center block w-full h-full bg-[length:62px_58px] bg-no-repeat text-0"></span>
          </Tab>
          <Tab className="h-[60px]" type="context" id="SSG" color="brown">
            <span className="bg-[url('/images/logo_ssg.png')] bg-center block w-full h-full bg-[length:62px_58px] bg-no-repeat text-0"></span>
          </Tab>
          <Tab className="h-[60px]" type="context" id="emart_everyday" color="brown">
            <span className="bg-[url('/images/logo_emart_everyday.png')] bg-center block w-full h-full bg-[length:62px_58px] bg-no-repeat text-0"></span>
          </Tab>
          <Tab className="h-[60px]" type="context" id="emart24" color="brown">
            <span className="bg-[url('/images/logo_emart24.png')] bg-center block w-full h-full bg-[length:62px_58px] bg-no-repeat text-0"></span>
          </Tab>
          <Tab className="h-[60px]" type="context" id="etc" color="brown">
            <span className="text-[10px]">기타 제휴사</span>
          </Tab>
        </div>

        <TabContent
          className="pt-8 font-medium"
          id="emart"
          name="이마트/이마트 트레이더스"
          h4={true}
        >
          <PointServiceTable>
            ...
            {emarttable.map((item) => (
              <TrValue rowSpan={item.rowSpan} colSpan={item.colSpan} point={item.point}>
                {item.content}
              </TrValue>
            ))}
          </PointServiceTable>
          ...
          <PointServiceTable>
            ...
            <TrValue rowSpan={1} colSpan={2} point={5}>
              <Image
                ...
                alt="이마트24"
              />
              <span className="font-normal block text-[11px] leading-[14px] pt-2 text-center">
                이마트24
              </span>
            </TrValue>
          </PointServiceTable>
      ...
      <div className="bg-[#fbfbfb] px-[30px] pb-10 relative pt-5">
        ...
        <ul className="-mx-2.5">
          <li>
            <StrongUnderline>구매 시 포인트로 결제</StrongUnderline>
            <ul className="list-none">
              <ListForNoticeBox level={6} isBullet>
                결제 시 보유하신 사용가능 포인트를 사용하실 수 있습니다.
              </ListForNoticeBox>
              <ListForNoticeBox className="pl-[14px] before:pl-[7px]" level={2} isHyphen>
          ...
          <li className="mt-6">
            <StrongUnderline>신세계상품권으로 교환</StrongUnderline>
            <ListForNoticeBox className="text-[13px]" level={6} isBullet>
          ...
          <li className="mt-6">
            <StrongUnderline>소중한 사람에게 포인트 선물</StrongUnderline>
            <ListForNoticeBox className="text-[13px]" level={6} isBullet>
          ...
          <li className="mt-6">
            <StrongUnderline>다양한 포인트/마일리지 전환</StrongUnderline>
            <ListForNoticeBox className="text-[13px]" level={6} isBullet>
      ...
      <div className="bg-[#fbfbfb] px-[30px] pb-10 relative">
        ...
        <p className="-tracking-[.4px] text-[13px] leadint-[21px] text-[#767676] -mx-2.5 mb-4">
          신세계포인트의 유효기간은, 적립일로부터 2년(24개월)이며, 유효기간이 경과된 신세계포인트는
          월 단위 선입선출방식에 의하여 자동 소멸됩니다.
        </p>
        <ul className="-mx-2.5">
          <li>
            <StrongUnderline>소멸포인트 확인</StrongUnderline>
            <ul className="list-none">
              <ListForNoticeBox level={6} isBullet>
          ...
          <li className="mt-6">
            <StrongUnderline>소멸포인트 안내</StrongUnderline>
            <ListForNoticeBox className="text-[13px]" level={6} isBullet>
