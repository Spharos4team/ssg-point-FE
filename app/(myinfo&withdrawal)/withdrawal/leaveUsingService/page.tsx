      ...
      <div className="px-5 pb-10">
        ...
        <NoticeBox type="simple" className="!pb-0 !pt-2">
          <ListForNoticeBox level={2} isBullet>
            통합 멤버십을 가입하신 경우, 가입처에서 해당 멤버십을 먼저 탈퇴해
            주셔야 신세계포인트 탈퇴가 가능합니다. 탈퇴는 가입처에 문의해주세요.
          </ListForNoticeBox>
          <ListForNoticeBox level={2} isBullet>
            멤버십 가입일자와 혜택이 적용되는 시작일자는 상이할 수 있습니다.
          </ListForNoticeBox>
          <ListForNoticeBox level={2} isBullet>
            신세계 유니버스 클럽을 탈회 하셔도, 해당 포인트 카드로 신세계포인트
            서비스는 계속 이용하실 수 있습니다.
          </ListForNoticeBox>
          <ListForNoticeBox level={2} isBullet>
            G마켓/옥션의 스마일 클럽에서 신세계 유니버스 클럽으로 전환한 회원의
            경우, 스마일 클럽의 첫 가입일자가 표기됩니다.
          </ListForNoticeBox>
        </NoticeBox>
      </div>
              ...
              <div className="flex gap-x-4 px-5 pt-5 pb-5 box-border">
                ...
                <div>
                  ...
                  <p className="text-[13px] text-[#505050] leading-[21px]">
                    신세계포인트 통합ID로 이용중인 위의 온라인 서비스들을 더
                    이상 이용할 수 없게 됩니다.
                  </p>
                </div>
              </div>
