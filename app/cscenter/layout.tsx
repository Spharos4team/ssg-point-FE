...
export default function CscenterLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="mt-12">
      <TabBarTopCont align="between" activeColor="purple" lineType="primary" pages={pagesInMy} />
      {children}
    </div>
  );
}
