...
export default function SuccessPage() {
  ...
  return (
    <>
      ...
      <div className="px-5 py-5">
        <h3 className="text-xl leading-[24px] font-medium pb-5 border-b border-black">회원정보</h3>
        <p className="text-base font-medium pt-5">휴대폰 번호</p>
        <p className="text-base font-normal text-gray-500">010-95**-50**</p>
        <p className="text-base font-medium pt-5">주소</p>
        <p className="text-base font-normal text-gray-500">부산 북구 금곡대로, *****</p>
        <p className="text-base font-medium pt-5">이메일</p>
        <p className="text-base font-normal text-gray-500">없음</p>
      </div>
      <div className="px-5 py-5">
        ...
        <p className="text-base font-medium pt-5">동의</p>
        <p className="text-base font-normal text-gray-500">이메일, 문자, DM, TM, APP PUSH</p>
      </div>
    </>
  );
}
