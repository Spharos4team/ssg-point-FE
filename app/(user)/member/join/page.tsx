      ...
      <div className="px-5 pb-10">
        <ol className="divide-y">
          <li className={`relative h-[92px] box-border pl-[90px] ${joinIcon} `}>
            <span className="inline-block text-xs leading-5 pr-2 pt-9">STEP. 1</span>
            <span className="inline-block font-medium text-base leading-[26px] pt-9">본인인증</span>
          </li>

          <li
            className={`relative h-[92px] box-border pl-[90px] ${joinIcon} before:bg-[center_top_-70px]`}
          >
            <span className="inline-block text-xs leading-5 pr-2 pt-9">STEP. 2</span>
            <span className="inline-block font-medium text-base leading-[26px] pt-9">약관동의</span>
          </li>

          <li
            className={`relative h-[92px] box-border pl-[90px] ${joinIcon} before:bg-[center_top_-140px]`}
          >
            <span className="inline-block text-xs leading-5 pr-2 pt-9">STEP. 3</span>
            <span className="inline-block font-medium text-base leading-[26px] pt-9">정보입력</span>
          </li>

          <li
            className={`relative h-[92px] box-border pl-[90px] ${joinIcon} before:bg-[center_top_-210px]`}
          >
            <span className="inline-block text-xs leading-5 pr-2 pt-9">STEP. 4</span>
            <span className="inline-block font-medium text-base leading-[26px] pt-9">가입완료</span>
          </li>
        </ol>
