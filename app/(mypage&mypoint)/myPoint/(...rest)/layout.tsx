...
export default function RegAffLayout({ children }: { children: React.ReactNode }) {
    ...
    },
    {
      ...
      title: (
        <>
          마음을 담아
          <br />
          <span className="text-[#ea035c] font-medium">신세계포인트를 선물</span>
          하세요!
        </>
      ),
      subTitle:
    ...
    },
    {
      ...
      title: (
        <>
          포인트 적립을 깜빡하셨나요?
          <br />
          <span className="text-[#ea035c] font-medium">영수증 정보만 입력해 주세요.</span>
        </>
      ),
      subTitle:
