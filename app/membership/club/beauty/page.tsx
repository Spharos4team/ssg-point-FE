  ...
  return (
    <div className="-mt-20">
      ...
      <div className="pt-6 px-5 pb-[60px]">
        ...
        <div className="pt-10">
          <p className="text-base leading-[26px] font-medium">해당 브랜드</p>
          <PointServiceTable className="px-[5px] pt-4 pb-2 border-b-[1px] border-b-solid border-b-[#e8e8e8]">
            {brandlist.map((item) => (
              <ListForNoticeBox className="inline-block !text-[13px] w-1/3 mt-2" level={6} isBullet>
                {item}
              </ListForNoticeBox>
            ))}
          </PointServiceTable>
        ...
        <Button className="mt-10 h-12" backgroundColor={'primary'} onClick={''}>
          가입하기
        </Button>
      </div>
    </div>
