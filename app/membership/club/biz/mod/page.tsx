  ...
  return (
      <div className='-mt-20'>
          <div className="bg-[#efe8f3] pt-6 pr-[118px] pb-5 pl-[30px] min-h-[130px] relative box-border">
            <h2 className="text-[#5c1880] text-[13px] leading-[21px] block font-bold ">
                비즈 클럽
            </h2>
                    ...
                    <form>
                        ...
                        <div className="pb-4 box-border">
                            ...
                            <div className="mb-2 flex">
                                ...
                                />
                                <Button
                                    className="ml-[5px] h-12 py-3 font-normal !w-auto px-[45px] whitespace-nowrap"
                                >
                                    우편번호찾기
                                </Button>
                            </div>
                        ...
                        <Button
                            className="mt-6 w-full h-[48px] rounded-lg"
