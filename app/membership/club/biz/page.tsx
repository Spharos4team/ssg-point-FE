              ...
              <div className="-mr-5 !overflow-y-auto">
                  <div className="mr-5">
                      ...
                      <div className="h-auto pt-[13px] ">
                          <p className="text-[15px] leading-6 text-black font-medium">
                              가입방법
                          </p>
                          <ol className="pt-5 list-none !p-0">
                            <ListForModal stepnum={1} txt={"비즈 클럽에 가입해 주세요."}/>
                            <ListForModal stepnum={2} txt={"가입을 완료하시면 세금계산서 발행 전용 모바일 카드가 자동으로 발급돼요."}/>
                            <ListForModal stepnum={3} txt={"사업자등록증 지참 후 이마트 매장 내 고객만족센터에 방문해서 세금계산서 발행을 위한 등록 절차를 진행해 주세요."}/>
                            <ListForModal stepnum={4} txt={"이마트에서 계산 시 세금계산서 발행 전용 모바일 카드를 제시해 주세요."}>
                              <Image
                            ...
                            <ListForModal stepnum={5} txt={"비즈 클럽 가입 시 등록하신 이메일 주소로 세금계산서가 발송되며, 약 1~2주 정도 소요됩니다."}/>
