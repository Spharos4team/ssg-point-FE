  ...
  return (
    <div className="p-0 relative">
      <h3 className="text-[18px] leading-[28px] font-normal px-5 pb-4">
        신세계포인트 통합 ID 서비스 TIP​
      </h3>
      <ul className="mx-5 mb-20 list-none">
        <li className="mb-2 relative">
          <Link
            className="block min-h-[146px] py-4 pl-4 bg-white box-border border-[1px] border-solid border-[#e8e8e8]
          ...
          <div>
            <span className="absolute top-[98px] left-[21px] z-[1] w-[70px] h-[28px] box-border text-center bg-white pt-[3px] border-[1px] border-solid border-[#e8e8e8] text-xs leading-5 text-[#767676]">
              가입완료
            </span>
          </div>
        </li>
        <li className="mb-2 relative">
          ...
          <div>
            <button className="absolute top-[98px] left-[21px] z-[1] w-[70px] h-[28px] box-border text-center bg-[#04857f] pt-[1px] border-[1px] border-solid border-[#04857f] text-xs leading-5 text-white">
              가입하기
            </button>
          </div>
          <div className="p-4 border-[1px] border-solid border-[#e8e8e8] border-t-none">
            <p className="text-[13px] leading-[21px] text-black">
              신세계아울렛 이용약관 및 개인정보 수집·이용동의 내용을 확인하였으며, 아래 내용에
              동의합니다.
            </p>
            ...
            <div className="mt-[8px] ml-[11px] py-2 pl-5 border-l border-black">
              <p className="text-[14px] leading-6 mb-4">신세계아울렛 광고정보 수신동의</p>
              <ValueProvider>
                <Checkbox
            ...
            <Button className="h-12 mt-4" backgroundColor="primary">
              동의하기
            </Button>
            <Button
              type={'basic'}
