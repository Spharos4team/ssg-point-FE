...
const PagesMembership: PageProp[] = [
  ...
  },
  {
    ...
    _href: [
      '/membership/club',
      '/membership/club/momkids',
      '/membership/club/momkids/detail',
      '/membership/club/parking',
      '/membership/club/parking/detail',
      '/membership/club/beauty',
      '/membership/club/biz',
      '/membership/club/biz/mod',
    ],
    name: '클럽',
  },
  {
...
export default function MembershipLayout({ children }: { children: React.ReactNode }) {
  const pageHeaders: PageProp[] = [
    ...
    },
    {
      ...
      subTitle: '고객님의 취향에 따른 맞춤 클럽 혜택으로<br />',
    },
  ];
  ...
  return (
    <div className="mt-12">
      ...
      <ContentHeader main={currPage?.title} sub={currPage?.subTitle as string} />
      {children}
    </div>
  );
}
