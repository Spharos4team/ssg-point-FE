    ...
    <div className="relative">
      ...
      <div className="chcheck_event_box">
        ...
        <div>
          <Image
            className="block w-full"
            src="/images/attend_img_bottom.jpg"
            alt="출석체크 참여방법 : 신세계포인트에 로그인하기 - 캘린더에서 오늘의 날짜 선택하여 출석체크 하기 - 출석 횟수에 따라서 포인트 받기   (유의사항) 1일 1회 참여 가능합니다. 지급된 포인트는 당일 사용이 가능합니다. "
            width="750"
            height="815"
          />
        </div>
