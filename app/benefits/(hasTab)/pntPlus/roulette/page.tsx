...
export default function Home() {
  return (
    <div className="ruckyRoulette relative">
      ...
      <Image
        className="notice_img block w-full"
        src="/images/roulette_notice_img.jpg"
        alt="START 를 눌러 룰렛 돌리기 잠깐! 푸시 알림 동의하는 방법을 안내드립니다. (단 앱에서만 가능합니다.) 하나, 앱 설정에서 버튼을 ON으로! - 상단의 메뉴바 클릭 - 설정 아이콘 클릭 - 푸시 알림 동의 버튼 클릭 둘, 광고정보 수신관리에서 체크! - 하단 메뉴의 마이회원정보 클릭 - 광고정보 수신관리 클릭 - 푸시알림 동의 체크 클릭   유의사항) 앱 푸시 알림 동의 회원에 한해 1일 1회 참여가 가능합니다. 지급된 포인트는 당일 사용이 가능합니다. "
        width={750}
        height={2034}
      />
    </div>
