    ...
    <>
        ...
        <div className="point_lists ">
          <div className="point_wrap border-t-[1px] border-solid border-black flex justify-between items-center h-[74px]">
            <div className="point_head pl-4">
              <p className="point_tit text-[13px] leading-[21px]">
                신세계포인트
              </p>
              <p className="point_txt text-[13px] leading-[21px] font-medium">
                (사용 가능)
              </p>
            </div>
            <PointIcon point={361} />
      ...
      <div className="brand_use_wrap01 px-5 pb-5">
        <SpecialTitle
          ...
          name={"권선"}
          ptag={
            "text-[20px] leading-[30px] font-normal break-keep -tracking-[.5px]"
          }
        >
          고객님이 <br />
          자주 방문하는 브랜드
      ...
      >
        <ListForNoticeBox
          ...
          isBullet={true}
        >
          매년 1월 1일 ~ 전일까지의 신세계포인트 적립/사용한 결제 건을 기준으로
          집계되며 환불, 취소 등으로 인한 실제 결제 금액과 일부 차이가 있을 수
          있습니다.
        </ListForNoticeBox>
        <ListForNoticeBox
          className="text-[12px] leading-[20px] -tracking-[.5px]"
