...
const findstore = () => {
    ...
    return (
        <div className="p-0">
            ...
            <div
                id={'map'}
                className="find_store_wrap01">
                <NaverMap/>
            </div>
                :
            <div
                id={'region'}
                className="find_store_wrap02 pt-10 pb-20 px-5">
                <div
                ...
                <div
                    className="w-[50%] h-12 rounded-lg inline-block mt-2.5"
                >
                <Dropdown
                    mainTitle={'시'}
                    id={'2'} options={['4', '5', '6']}/>
                ...
                <div
                    className="w-[50%] h-12 rounded-lg inline-block pl-2.5"
                >
                <Dropdown
                    mainTitle={'군/구'}
                    id={'3'} options={['7', '8', '9']}/>
