      ...
      <div className="relative px-6 pt-6 pb-8 border-t-[1px]">
        ...
        <div className="txt_cnt">
          <p className="pt-1 pb-2">
            <span className="block text-[12px]">㈜이마트 서울시 중구 세종대로 7길 37(순화동)</span>
            <span className="inline-block mr-2 text-[12px]">대표자: 강희석</span>
            <span className="inline-block mr-2 text-[12px]">사업자등록번호 : 206-86-50913</span>
          </p>
          <p className="text-[10px] leading-[1em]">COPYRIGHT (c) EMART INC. ALL RIGHTS RESERVED.</p>
        </div>
