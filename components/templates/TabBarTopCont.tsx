...
export default function TabBarTopCont({
  ...
  return (
    <div className="p-0">
      ...
      >
        <ul className={`flex flex-nowrap w-full h-full box-border overflow-x-auto scrollbar-hide`}>
          {pages.map(({ _id, _href, name }) => (
            <li
              ...
              key={_id}
            >
              <Link className={`${tab}`} href={Array.isArray(_href) ? _href[0] : _href} prefetch>
                {name}
