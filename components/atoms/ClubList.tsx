        ...
        switch (type) {
            case "list": {
                ...
                <span className={`${txtColor} align-top pt-1 table-cell w-auto p-0`}>
                  <span className="text-base leading-[26px] block font-medium pb-1">
                    {title}
                  </span>
                  <span className="text-[13px] leading-[21px] block break-keep"
        ...
        case "detail": {
            return (
                <div className={`${bgColor} relative py-8 pr-[130px] pl-[30px] box-border min-h-[174px]`}>
                    <h2 className={`${txtColor} text-xl font-bold leading-[30px]`}>
                        {title}
                    </h2>
                    <p className={`${txtColor} text-[14px] leading-6 pt-2 break-keep`} dangerouslySetInnerHTML={{__html: subtext}}></p>
                    <Image
