...
const BarcodeBox = () => {
  ...
  const arrow =
    "after:absolute after:top-1/2 after:-translate-y-1/2 after:ml-1 after:w-[9px] after:h-[6px] after:bg-contain after:bg-[url('/images/icon_back.png')] after:bg-[99%_auto] after:rotate-180 after:bg-center after:bg-no-repeat";
  return (
    <div
      className={`${
    ...
    >
      <div className="pt-[13px] pb-[16px]">
        <div className="relative mx-auto overflow-hidden z-[1]">
          <p className="inline-block ml-[19px] indent-[-99em] w-[117px] h-[21px] bg-[url('/images/point_card_logo.png')] bg-[100%_auto] bg-no-repeat">
            SHINSEGAE POINT
          </p>
          <p className="inline-block float-right pr-[16px] text-base font-bold after:relative after:inline-block after:top-[4px] after:ml-[1px] after:w-[9px] after:h-[16px] after:bg-[url('/images/point_mark.png')] after:bg-[100%_auto] after:bg-no-repeat">
            12
          </p>
          <div className="mx-auto mt-[12px] relative p-[5px] pt-[6px] w-full max-w-[328px] min-h-[90px] text-center box-border rounded-lg bg-white">
            <Barcode type="detail" value="9350-1200-1875-5220" height={75} />
          </div>
