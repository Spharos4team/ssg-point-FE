        ...
        <tr>
            <th scope={'row'} colSpan={colSpan ?? 1}
                ...
                <Image
                    ...
                    width={width1}
                    height={height1}/>
                <span className="font-normal block text-[11px] leading-[14px] pt-2 text-center">{content1}</span>
            </th>
            <th scope={'row'} colSpan={colSpan ?? 1}
                className="border-r-[1px] border-r-solid border-r-[#e8e8e8] border-b-[1px] border-br-solid border-b-[#e8e8e8] font-normal break-all px-2 py-[15px] text-left text-xs leading-5 align-middle">
                <Image
                    ...
                    width={width2}
                    height={height2}/>
                <span className="font-normal block text-[11px] leading-[14px] pt-2 text-center">{content2}</span>
            </th>
            {rowSpan === 0 ? <></> :
