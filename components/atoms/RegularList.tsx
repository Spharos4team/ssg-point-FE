          ...
          >
            <div className="pl-[90px] relative table-cell align-middle pr-[65px]">
              ...
              <button
                ...
                className="bg-[url('/images/regular_mark.png')] bg-no-repeat bg-[100%_auto] w-5 h-[26px] absolute right-[30px] top-1/2 -mt-[13px] indent-[-999em] text-[1px] overflow-hidden"
              >
                단골매장 삭제
              </button>
            </div>
